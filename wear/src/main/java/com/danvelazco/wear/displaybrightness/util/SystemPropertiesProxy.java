...
public class SystemPropertiesProxy {
    ...
    /**
     * Get the value for the given key, returned as a boolean. Values 'n', 'no', '0', 'false' or 'off' are considered
     * false. Values 'y', 'yes', '1', 'true' or 'on' are considered true. (case insensitive). If the key does not exist,
     ...
     *         if the value exceeds 92 characters
     */
    public static void set(Context context, String key, boolean val) throws IllegalArgumentException {
